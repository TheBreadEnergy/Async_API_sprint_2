...
from testdata.person_data import (PERSON_MOCK_DATA,
                                  PERSON_PAGINATION_TEST_QUERY,
                                  PERSON_SEARCH_TEST_QUERY,
                                  PERSON_SORT_TEST_QUERY)
from testdata.person_template import PERSON_TEMPLATE
...
async def test_pagination(
    ...
    await es_write_data(test_settings.es_person_index, PERSON_TEMPLATE, PERSON_MOCK_DATA)
